...
<div class="user_info" style="background-color: #377e84; height: 200px">
    ...
    <div class="les_info">
        <div class="theory">
            <div style="font-size: 3ex; margin: 18px 0">Каким из этих элементов обозначается ввод или вывод данных?</div>
        </div>
        <div class="progress" style="top:70px">
            <div class="fill" style="width: 225px">
            </div>
            <div class="all">
            </div>
        </div>
                ...
                <tr>
                    <td>
                        <div class="form-item radio-btn nth-2">
                            ...
                            <label for="radio1"> <img src="../images/start.png"></label>
                        </div>
                    </td>
                    <td>
                        <div class="form-item radio-btn nth-2">
                            <input type="radio" name="option1" id="radio2" value="2" onChange="this.form.submit()">
                            <label for="radio2"> <img src="../images/parallelogr.png"></label>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="form-item radio-btn nth-2">
                            ...
                            <label for="radio3"> <img src="../images/circle2.png"> </label>
                        </div>
                    </td>
                    <td>
                        <div class="form-item radio-btn nth-2">
                            <input type="radio" name="option1" id="radio4" value="4" onChange="this.form.submit()">
                            <label for="radio4"> <img src="../images/romb.png"> </label>
                        </div>
                    </td>
                </tr>
            </table>
            ...
            switch( $_GET['option1'] )
            {
                ...
                case '4':
                    ...
                    '<div class="t_f_msg" style="border: 10px solid #bf3329;">
                        <b>Неверно</b>
                        <br>
                        Операции ввода и вывода данных обозначаются параллелограммом
                        <br>
                        <img src="../images/data.jpg">
                        <div class="next_les">
                        <a class="arrow-3" href="4.php">Далее
