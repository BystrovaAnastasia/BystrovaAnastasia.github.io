...
<div class="lesson_class">
    <div class='but_class'>
        ...
        if (mysqli_num_rows($check_lessons) > 0) {
            ...
            $_SESSION['message'] = 'Нет добавленных уроков';
        }
        ?>
    ...
    <!--<div class="les_but">
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
            <div class="u_button" style="right: 25%; top: 45%; justify-content: center;
    align-items: center; display: flex; flex-direction: row;">
                <button type="submit" class="user_button" onclick="document.location='settings.php'">
                    <i class="material-icons">trending_flat</i>
                    <span class="title">Начать урок</span>
                </button>
            </div>
    </div>-->
    <?php
